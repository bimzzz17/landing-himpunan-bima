...
<head>
    ...
    <style>
        body{margin:0;font-family:Arial,sans-serif;background:linear-gradient(135deg,#eef2ff,#f8fbff);color:#1f2a44;}
        .container{max-width:1100px;margin:auto;padding:20px;}
        header{background:#fff;border-bottom:1px solid #dfe6ff;position:sticky;top:0;}
        nav{display:flex;justify-content:space-between;align-items:center;padding:14px 0;}
        .logo{display:flex;align-items:center;gap:10px;}
        .logo img{width:40px;}
        nav a{text-decoration:none;color:#3b4b7c;margin-left:15px;font-weight:500;}
        nav a:hover{color:#2b59ff;}
        .hero{text-align:center;padding:40px 0;}
        .hero h1{font-size:40px;margin-bottom:10px;}
        .hero p{color:#5c6b94;}
        .devisi-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:20px;margin-top:30px;}
        .devisi-card{background:#fff;padding:25px;border-radius:15px;text-align:center;border:1px solid #e0e6ff;transition:0.3s;box-shadow:0 5px 15px rgba(0,0,0,0.05);}
        .devisi-card:hover{transform:translateY(-8px);box-shadow:0 10px 25px rgba(0,0,0,0.1);}
        .icon{width:60px;height:60px;background:#2b59ff;color:#fff;display:flex;align-items:center;justify-content:center;border-radius:50%;font-size:24px;margin:auto;margin-bottom:15px;}
        .devisi-card h3{margin-bottom:10px;}
        .devisi-card p{font-size:14px;color:#5c6b94;}
        footer{text-align:center;margin-top:40px;padding:20px;color:#5c6b94;}
    </style>
</head>
<body>
<header>
