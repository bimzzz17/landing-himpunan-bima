...
nav a{text-decoration:none; color:#3b4b7c; margin-left:14px; font-weight:500;
}
...
.proker-section{margin-top:20px;
}
.proker-title{text-align:center; margin-bottom:20px;
}
.gallery{display:grid; grid-template-columns:repeat(auto-fit,minmax(250px,1fr)); gap:18px;
}
.proker-card{background:#fff; border-radius:12px; overflow:hidden; box-shadow:0 6px 14px rgba(0,0,0,0.08); transition:0.3s;
}
.proker-card:hover{transform:translateY(-5px);
}
.proker-card img{width:100%; height:180px; object-fit:cover;
}
.proker-content{padding:14px;
}
.proker-content h3{margin:0; font-size:18px;
}
.proker-content p{ font-size:14px; color:#5c6b94; margin-top:6px;
}
footer{margin-top:40px; padding:20px; text-align:center; border-top:1px solid #dfe6ff; color:#5c6b94;
}
</style>
</head>
<body>
...
<section class="hero">
<h1>Program Kerja</h1>
<p>Dokumentasi kegiatan proker Himpunan Mahasiswa Informatika</p></section>
